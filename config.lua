Config = {
    ...
    Locales = {
        ["checkout"] = "Kasa",
        ["drinks"] = "Icecekler",
        ["snacks"] = "Abur cuburlar",
        ["readymeal"] = "Hazir Yemekler",
        ["diverse"] = "Cesitli",
    },

    Items = {
        ["drinks"] = {
            {label = "Kola", item = "cocacola", price = 14},
            {label = "Sprite", item = "sprite", price = 14},
        },
        ["snacks"] = {
            {label = "Peynirli Cips", item = "cheesebows", price = 12},
            {label = "Cips", item = "chips", price = 12},
            {label = "Marabou Cikolata", item = "marabou", price = 12},
        },
        ["readymeal"] = {
            {label = "Pizza", item = "pizza", price = 30},
            {label = "Pastirmali Burger", item = "burger", price = 27},
            {label = "Sandvic", item = "macka", price = 8},
        },
        ["diverse"] = {
            {label = "Sigara", item = "cigarett", price = 10},
            {label = "Cakmak", item = "lighter", price = 20},
        },
    },
}